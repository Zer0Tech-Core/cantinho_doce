  ...
  return (
    <div className="products-grid">
      {produtos.map((produto) => {
        ...
        return (
          // 🔥 AGORA O CARD É UM LINK PARA A PÁGINA DO PRODUTO
          <Link
            key={produto.id}
          ...
          >
            ...
            <div className="product-info">
              ...
              {/* 🔥 AÇÕES COM stopPropagation PARA NÃO NAVEGAR */}
              <div 
                className="product-actions" 
                onClick={(e) => e.preventDefault()} // 🔥 Impede a navegação ao clicar nos botões
              >
                {qtd === 0 ? (
                  <button 
                    className="btn-add"
                    onClick={(e) => {
                      e.stopPropagation() // 🔥 Impede o Link de navegar
                      e.preventDefault()
